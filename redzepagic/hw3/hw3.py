...
def isperfect(n: int ):
    ...
    ### BEGIN CODE #####
    for i in range(2, (n//2 + 1)): # Hint: you can use the range, or any sequence type. if you don't remember how it works, have a look at the documentation.
        quad = i**2
        if quad == n : # replace None by the appropriate code.
            return (True, i)
        if quad > n:
            return (False, n)
    return (False, n)
